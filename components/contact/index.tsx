  ...
  return (
    <div className="mt-6">
      ...
      <div className="flex flex-col border-border border-t">
        <Link href="mailto:contact@mcisted.com" className="border-border border-b py-2">
          <span className="transition-opacity hover:opacity-50">Email</span>
        </Link>
        <Link href="https://linkedin.com/in/maxmcisted" className="border-border border-b py-2" target="_blank">
